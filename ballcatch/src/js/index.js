...
*/
	...
	function update () {
        ...
        if(ball.y > game.world.height - 10){
            this.reward -= 1;
            ball.x =  Math.random()*(150-20)+20;
            ball.y = 10;
            ball.body.velocity.set(0, 180);
...
*/
	...
	function render () {
        this.text.setText('fps:' + game.time.fps + 'time' +  Math.ceil(60 - Math.ceil(this.timeCount/60)) + 'gen:' + this.generation + 'score:' + this.score)
        /*
